...
function Tilt({children}) {
  ...
  // substituir o id por essa referência
  // referencia essa, isolada do componente
  ...
  React.useEffect(() => {
    ...
    const tiltNode = divRoot.current //retorna o elemento que foi referenciado
    // mais ou menos o "getElementById()"
    VanillaTilt.init(tiltNode, {
      max: 25,
      speed: 400,
      glare: true,
